...
class Enemy_orco(Enemy):
    ...
    def draw(self, screen):
        ...
        # Dibujar sombra
        shadow_rect = pygame.Rect(0, 0, 60, 20)  # Tamaño de la sombra
        shadow_rect.center = (self.x, self.y + 35)  # Posición debajo del enemigo
        pygame.draw.ellipse(screen, (0, 0, 0, 128), shadow_rect)  # Sombra translúcida
...
class Slime(Enemy):
    ...
    def draw(self, screen):
        ...
        # Dibujar sombra
        shadow_rect = pygame.Rect(0, 0, 50, 15)  # Tamaño de la sombra
        shadow_rect.center = (self.x, self.y + 20)  # Posición debajo del enemigo
        pygame.draw.ellipse(screen, (0, 0, 0, 128), shadow_rect)  # Sombra translúcida
